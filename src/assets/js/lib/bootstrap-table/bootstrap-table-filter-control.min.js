...
!(function (a) {
  ...
  var b = a.fn.bootstrapTable.utils.sprintf,
    c = function (b, c, e) {
      if (((c = a.trim(c)), (b = a(b.get(b.length - 1))), d(b, c))) {
        b.append(
          a("<option></option>")
            .attr("value", c)
            .text(a("<div />").html(e).text())
        );
    ...
    d = function (a, b) {
      for (var c = a.get(a.length - 1).options, d = 0; d < c.length; d++)
        if (c[d].value === b.toString()) return !1;
      return !0;
    },
    e = function (a) {
    ...
    k = function (b, d) {
      var e,
        ...
        g = !1,
        h = 0;
      a.each(b.columns, function (h, i) {
        if (((e = "hidden"), (f = []), i.visible)) {
          if (i.filterControl) {
            f.push(
              '<div style="margin: 0 2px 2px 2px;" class="filterControl">'
            );
            var j = i.filterControl.toLowerCase();
            i.searchable &&
              b.options.filterTemplate[j] &&
              ((g = !0),
              (e = "visible"),
              f.push(b.options.filterTemplate[j](b, i.field, e)));
          } else f.push('<div style="height: 34px;"></div>');
          if (
            (a.each(d.children().children(), function (b, c) {
              return (
                (c = a(c)),
                c.data("field") === i.field
                  ? (c.find(".fht-cell").append(f.join("")), !1)
                  : void 0
              );
            }),
            void 0 !== i.filterData && "column" !== i.filterData.toLowerCase())
          ) {
            var k = i.filterData.substring(0, 3),
              l = i.filterData.substring(4, i.filterData.length),
              m = a("." + i.field);
            switch ((c(m, "", ""), k)) {
              case "url":
                a.ajax({
              ...
              case "var":
                var n = window[l];
                for (var o in n) c(m, o, n[o]);
            }
          }
        }
      }),
        g
          ? (d.off("keyup", "input").on("keyup", "input", function (a) {
              clearTimeout(h),
                (h = setTimeout(function () {
                  b.onColumnSearch(a);
                }, b.options.searchTimeOut));
            }),
            d.off("change", "select").on("change", "select", function (a) {
              clearTimeout(h),
                (h = setTimeout(function () {
                  b.onColumnSearch(a);
                }, b.options.searchTimeOut));
            }),
            d.off("mouseup", "input").on("mouseup", "input", function (c) {
              var d = a(this),
                e = d.val();
              "" !== e &&
                setTimeout(function () {
            ...
            d.find(".date-filter-control").length > 0 &&
              a.each(b.columns, function (b, c) {
                void 0 !== c.filterControl &&
                  "datepicker" === c.filterControl.toLowerCase() &&
                  d
                    .find(".date-filter-control." + c.field)
                    .datepicker(c.filterDatepickerOptions)
  ...
  a.extend(a.fn.bootstrapTable.defaults, {
    ...
    valuesFilterControl: [],
    filterTemplate: {
      input: function (a, c, d) {
        return b(
          '<input type="text" class="form-control %s" style="width: 100%; visibility: %s">',
          c,
          d
        );
      },
      select: function (a, c, d) {
        return b(
          '<select class="%s form-control" style="width: 100%; visibility: %s" dir="%s"></select>',
          c,
          d,
          l(a.options.alignmentSelectControlOptions)
        );
      },
      datepicker: function (a, c, d) {
        return b(
          '<input type="text" class="date-filter-control %s form-control" style="width: 100%; visibility: %s">',
          c,
          d
        );
      },
  ...
  var m = a.fn.bootstrapTable.Constructor,
    n = m.prototype.init,
    o = m.prototype.initToolbar,
    p = m.prototype.initHeader,
    q = m.prototype.initBody,
    r = m.prototype.initSearch;
  (m.prototype.init = function () {
    ...
    (m.prototype.initBody = function () {
      q.apply(this, Array.prototype.slice.apply(arguments));
      for (
        var b = this,
          d = this.options.data,
          e =
            this.pageTo < this.options.data.length
        ...
        a.each(this.header.fields, function (d, e) {
          var h = g[e],
            i =
              b.columns[a.fn.bootstrapTable.utils.getFieldIndex(b.columns, e)];
          if (
            ((h = a.fn.bootstrapTable.utils.calculateObjectValue(
              b.header,
              b.header.formatters[d],
              [h, g, f],
              h
            )),
            !(
              (i.checkbox && i.radio) ||
              void 0 === i.filterControl ||
              "select" !== i.filterControl.toLowerCase() ||
              !i.searchable ||
              (void 0 !== i.filterData &&
                "column" !== i.filterData.toLowerCase())
            ))
          ) {
            var j = a("." + i.field);
            void 0 !== j &&
              j.length > 0 &&
              (0 === j.get(j.length - 1).options.length && c(j, "", ""),
              c(j, h, h));
          }
        });
      }
        ...
        this.data = c
          ? a.grep(this.data, function (d, e) {
              for (var f in c) {
                var g =
                    b.columns[
                      a.fn.bootstrapTable.utils.getFieldIndex(b.columns, f)
                    ],
                  h = c[f].toLowerCase(),
                  i = d[f];
                if (
    ...
    (m.prototype.onColumnSearch = function (b) {
      h(this);
    ...
    (m.prototype.clearFilterControl = function () {
      if (this.options.filterControl && this.options.filterShowClear) {
        ...
        if (
          ...
          k.length > 0 &&
            ((this.filterColumnsPartial = {}),
            a(k[0]).trigger("INPUT" === k[0].tagName ? "keyup" : "change")),
          l.length > 0 && c.resetSearch(),
          c.options.sortName !== h.data("sortName") ||
            c.options.sortOrder !== h.data("sortOrder"))
        ) {
          var n = b(
            e.find(
              '[data-field="%s"]',
              a(k[0]).closest("table").data("sortName")
            )
          );
          c.onSort(h.data("sortName"), h.data("sortName")),
            a(n).find(".sortable").trigger("click");
        }
        clearTimeout(m),

...
/* ==========================================================================
	...
	function statusFormatter(data, rowData, index) {
		...
		if (data === 'Desactivar') classBtn = 'btn-danger';
		/* if (data === 'Pending') classBtn = 'btn-primary'; */
		if (data === 'Pendiente') classBtn = 'btn-warning';
		if (data === 'Activo') classBtn = 'btn-success';
		...
		return	'<div class="dropdown dropdown-status ' +
				...
				'<a class="dropdown-item" href="#">Desactivado</a>' +
